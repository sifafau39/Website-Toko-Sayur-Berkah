...
<div class="form-group form-group-lg">
  ...
  <div class="col-md-5">
    <input type="text" name="stok_produk" class="form-control" placeholder="Stok Produk" value="<?php echo set_value('stok_produk') ?>" required>
  </div>
</div>
...
<div class="form-group form-group-lg">
  ...
  <div class="col-md-10">
    <input type="text" name="keterangan_produk" class="form-control" placeholder="Keterangan Produk" value="<?php echo set_value('keterangan_produk') ?>" required>
  </div>
</div>
